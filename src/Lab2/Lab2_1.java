...
public class Lab2_1 {
    public static void main(String[] args) {
        ...
        while (true) {
            System.out.print("Введіть 'так' для вводу рядка або 'ні' для виходу: ");
            ...
            else if (userInput.equalsIgnoreCase("ні")) {
                break;
            }

            else {
                System.out.println("Некоректне введення. Будь ласка, введіть 'так' або 'ні'.");
            }
        }
